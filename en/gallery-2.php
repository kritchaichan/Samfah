...
$doorsQuery = $objCon->query("
    ...
    WHERE Picture_Door_Type = 'Folios'
    ...
    <section id="page-order" data-background-image="../images/background/welcome.jpg">
      <div class="container-order">
          <div class="box-catalog">
            <a href="gallery-1.php" class="arrow-btn pull-left"><span class="glyphicon glyphicon-menu-left"></span></a>
            FOLIOS
            <a href="gallery-3.php" class="arrow-btn pull-right"><span class="glyphicon glyphicon-menu-right"></span></a>
          </div>
          <div class="grid1"><!-- gird1-->
            <?php foreach ($doors as $door): ?>
            <div class="grid-item"><!-- gird-item -->
              <div class="header-gallery"><!-- header-gallery -->
              <?php if($door->Picture_Door_Type == "Folios"){$path_door  = '../images/folios/'.$door->Picture_Door_Name.'.jpg';
            }?>
