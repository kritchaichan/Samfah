            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="address-1 ff">
                        <p>91 หมู่ที่ 8 ถนนตลิ่งชัน-สุพรรณบุรี ตำบลละหาร อำเภอบางบัวทอง จังหวัดนนทบุรี 11110 เบอร์โทรศัพท์ 081-838-1368,085-920-9636</p>
                    ...
                    <div class="address-2 ff">
                        <p>84-88 ถนนบริพัตร แขวงบ้านบาตร เขตป้อมปราบศัตรูพ่าย จังหวัดกรุงเทพมหานคร 10100 เบอร์โทรศัพท์ 081-838-1368,085-920-9636</p>
                    ...
                    <div class="botton-chang-map">
                        <p id="botton-chang-map-2"><i class="fa fa-refresh" aria-hidden="true"></i>    Chang branch Click</p>
                    </div>
                </div>
            </div>
        </div>
